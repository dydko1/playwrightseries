...
//        ShippingCostCalculatorA calculator = new ShippingCostCalculatorA();
//
//        double weight = 10.0;
//
//        //String shippingType1 = "STANDARD";
//        double cost1 = calculator.calculateShippingCost("STANDARD", weight);
//        System.out.println("Shipping cost for " + "STANDARD" + ": " + cost1);
//
